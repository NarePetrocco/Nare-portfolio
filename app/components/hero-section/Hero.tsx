  ...
  return (
    ...
    >
      <div className="text sm:w-[60%]">
        ...
        >
          Actualmente enfocada en construir experiencias de usuario que impulsen el crecimiento.
        </motion.p>
      </div>

      {/* IMAGE */}
      <div data-blobity-tooltip="Narella" className="flex justify-center items-center py-10">
        <motion.div
          ref={imgRef}
          style={{ rotate }}
          className="relative w-[260px] h-[320px] sm:w-[300px] sm:h-[360px] md:w-[350px] md:h-[400px] xl:w-[390px] xl:h-[470px]"
          initial={{ opacity: 0 }}
          animate={animateIn1}
        >
          <Image
